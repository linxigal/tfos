...
from deep_insight.k.layers.convolution import Convolution1D, Convolution2D, Convolution3D
...
class MaxPool1D(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import MaxPool1DLayer
...
class AvgPool1D(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import AvgPool1DLayer
        from tfos.choices import PADDING
...
class MaxPool2D(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import MaxPool2DLayer
        from tfos.choices import PADDING
...
class AvgPool2D(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import AvgPool2DLayer
        from tfos.choices import PADDING
...
class MaxPool3D(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import AvgPool3DLayer
        from tfos.choices import PADDING

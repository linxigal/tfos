...
class Add(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import AddL
...
class Subtract(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import SubtractL
...
class Multiply(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import MultiplyL
...
class Average(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import AverageL
...
class Maximum(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import MaximumL
...
class Minimum(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import MinimumL
...
class Concatenate(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import ConcatenateL
...
class Dot(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import DotL

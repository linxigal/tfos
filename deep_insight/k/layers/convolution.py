...
class Convolution1D(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import Conv1DLayer
...
class Convolution2D(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import Conv2DLayer
...
class Convolution3D(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import Conv3DLayer
...
class Convolution2DTranspose(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import Conv2DTransposeLayer
        from tfos.choices import ACTIVATIONS, BOOLEAN, PADDING
...
class Convolution3DTranspose(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import Conv3DTransposeLayer
        from tfos.choices import ACTIVATIONS, BOOLEAN, PADDING

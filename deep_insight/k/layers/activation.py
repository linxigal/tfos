...
from deep_insight.k.layers.core import Dense
...
class LeakyReLU(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import LeakyReLULayer
...
class PReLU(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import PReLULayer
...
class ELU(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import ELULayer
...
class ThresholdedReLU(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import ThresholdedReLULayer
...
class Softmax(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import SoftmaxLayer
...
class ReLU(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import ReLULayer

...
class RMSprop(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import RMSpropLayer
...
class Adagrad(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import AdagradLayer
...
class Adadelta(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import AdadeltaLayer
...
class Adamax(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import AdamaxLayer
...
class Nadam(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import NadamLayer

...
class Masking(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import MaskingLayer
...
class Dropout(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import DropoutLayer
...
class SpatialDropout1D(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import SpatialDropout1DLayer
...
class SpatialDropout2D(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import SpatialDropout2DLayer
...
class SpatialDropout3D(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import SpatialDropout3DLayer
...
class Activation(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import ActivationLayer
...
class Reshape(Base):
    ...
    def run(self):
        param = self.params
        from tfos.k.layers import ReshapeLayer
...
class Permute(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import PermuteLayer
...
class Flatten(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import FlattenLayer
...
class RepeatVector(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import RepeatVectorLayer
...
class Lambda(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import LambdaLayer
...
class Dense(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import DenseLayer
...
class ActivityRegularization(Base):
    ...
    def run(self):
        ...
        from tfos.k.layers import ActivityRegularizationLayer
